---
title: "Monrovia"
section: "jurisdictions/indiana/morgan-county/municipalities/monrovia"
order: 100
visibility: public
tags: [indiana, morgan-county, monrovia]
updated: 2026-05-11
# verification-needed: setbacks, stormwater_thresholds, recording_requirements, plat_requirements, official-site
# Small town; official website not verified. All numeric values null pending
# verification against current Town of Monrovia ordinances (if available).
submittal_checklist:
  - id: site-plan
    label: "Site / development plan to local Plan Commission or Morgan County"
    category: submittal
    citation: "Town of Monrovia ordinances or Morgan County Subdivision Control Ordinance (verify jurisdiction)"
  - id: drainage-plan
    label: "Drainage plan signed and sealed by Indiana-licensed PE"
    category: submittal
    citation: "Morgan County Stormwater / Drainage Ordinance (verify)"
  - id: county-plat-recording
    label: "Record approved plat with Morgan County Recorder"
    category: recording
    citation: "IC 36-2-11"
setbacks:
  ...
  citations:
    - "Town of Monrovia or Morgan County Zoning Ordinance (verify)"
stormwater_thresholds:
  detention_trigger_sqft: null
  water_quality_trigger_sqft: null
  bmp_required_above_sqft: null
  citations:
    - "Morgan County Stormwater / Drainage Ordinance (verify)"
...
recording_requirements:
  ...
  citations:
    - "IC 36-2-11"
    - "Morgan County Recorder fee schedule (verify)"
plat_requirements:
  - item: "north arrow"
    required: true
  - item: "graphic scale"
...
> **TL;DR**
> 1. Small town in northern Morgan County. Verify official site.
