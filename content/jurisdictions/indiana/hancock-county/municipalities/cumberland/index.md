---
title: "Cumberland"
section: "jurisdictions/indiana/hancock-county/municipalities/cumberland"
order: 100
visibility: public
tags: [indiana, hancock-county, cumberland]
updated: 2026-05-11
sources:
  - title: "Cumberland"
    url: "https://www.town.cumberland.in.us/"
    verified: 2026-05-06
# verification-needed: setbacks, stormwater_thresholds, recording_requirements, plat_requirements
# Cumberland straddles the Marion/Hancock county line; verify which county recorder
# accepts a given plat. All numeric values null pending verification.
submittal_checklist:
  - id: site-plan
    label: "Site / development plan to Cumberland Plan Commission"
    category: submittal
    citation: "Town of Cumberland zoning + subdivision ordinances (verify)"
  - id: drainage-plan
    label: "Drainage plan signed and sealed by Indiana-licensed PE"
    category: submittal
    citation: "Town of Cumberland stormwater ordinance (verify)"
  - id: county-plat-recording
    label: "Record approved plat with the appropriate county Recorder (Marion or Hancock)"
    category: recording
    citation: "IC 36-2-11"
setbacks:
...
recording_requirements:
  ...
  citations:
    - "IC 36-2-11"
    - "County Recorder fee schedule (verify)"
plat_requirements:
  - item: "north arrow"
    required: true
  - item: "graphic scale"
...
> **TL;DR**
> 1. Straddles Marion/Hancock county line.
> 2. Visit the official site for current ordinances, design standards, and submittal requirements: https://www.town.cumberland.in.us/
> 3. Page is a stub; expand with engineering contact, adopted standards manual, plan-review checklist.

## Authorities

- **Official site** — https://www.town.cumberland.in.us/
- Hancock County government — see [county page](../../index.md).
