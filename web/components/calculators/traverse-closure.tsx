...
/**
 * Embeddable traverse-closure widget.
 *
 * This is the pattern reference for extracting an inline calculator UI
 * from `app/tools/<name>/page.tsx` into a reusable component. The
 * widget intentionally omits page-level chrome (breadcrumb nav, wide
 * outer padding, page title) so it renders cleanly inside an iframe of
 * arbitrary width. The standalone `/tools/traverse-closure` page
 * remains the authoritative UI and is not modified.
 */
...
export default function TraverseClosureWidget() {
    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-ink-600">
          ...
          Enter bearings as azimuths (0-360 degrees clockwise from north).
        </p>
      </header>
      ...
      <section className="rounded-md border border-ink-200 p-4">
        ...
        <div className="mt-4 flex gap-3">
          ...
          <button
            ...
            className="rounded-md bg-ink-900 px-4 py-1.5 text-sm font-medium text-white transition hover:bg-ink-700"
          >
            Compute
          </button>
        </div>
      ...
      {result && (
        <section className="space-y-4">
          <div className="rounded-md border border-ink-200 p-4">
            <h2 className="mb-2 text-base font-semibold">Closure summary</h2>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm">
                  <thead>
                    <tr className="border-b border-ink-200 text-ink-600">
                      <th className="pb-2 pr-4 font-medium">#</th>
                      <th className="pb-2 pr-4 font-medium">Az</th>
                      <th className="pb-2 pr-4 font-medium">Dist</th>
          ...
          <p className="text-xs text-ink-500">
            Compass Rule (Bowditch) adjustment. Reference: Wolf &amp; Ghilani,{" "}
